...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ELIPS is an in-process vector and document retrieval engine built in C++23, with native Python bindings, ANN indexes, hybrid retrieval, and segmented persistence." },
      ...
      { name: "twitter:description", content: "An embedded vector and document retrieval engine in C++23. Python and C++ SDKs." },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "preconnect", href: "https://fonts.googleapis.com" },
      { rel: "preconnect", href: "https://fonts.gstatic.com", crossOrigin: "anonymous" },
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500;600&family=Caveat:wght@400;500;600;700&family=Kalam:wght@300;400;700&display=swap" },
      { rel: "icon", href: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Crect width='32' height='32' rx='6' fill='%23f54e00'/%3E%3Ctext x='50%25' y='58%25' text-anchor='middle' font-family='Inter,sans-serif' font-size='18' font-weight='700' fill='white'%3Ee%3C/text%3E%3C/svg%3E" },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "ELIPS",
          description: "Embedded Local Index & Persistence System — an in-process vector and document retrieval engine.",
